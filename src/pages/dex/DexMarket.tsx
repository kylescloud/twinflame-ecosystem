...
import { Search, TrendingUp, TrendingDown, Flame, Star, Zap, ArrowRight } from "lucide-react";
            ...
            <tbody>
              {filtered.map((coin, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-right text-foreground hidden sm:table-cell">{formatNum(coin.marketCap)}</td>
                  <td className="px-4 py-3 text-right text-foreground hidden md:table-cell">{formatNum(coin.volume24h)}</td>
              ...
              {filtered.length === 0 && (
                <tr>
                  <td colSpan={8} className="py-12 text-center text-sm text-muted-foreground">No tokens found</td>
                </tr>
              )}
            </tbody>
          </table>
